...
.s-expandable {
  ...
  --_ex-after-h: 10px;
  --_ex-after-hmx: 0;
  --_ex-after-transition: height var(--_ex-transition-duration) linear,
        max-height 0s var(--_ex-transition-duration) linear;
  --_ex-content-hmx: 1000000px;
  --_ex-content-mb: 0;
  --_ex-content-o: unset;
  --_ex-content-transform: unset;
  --_ex-content-transition: margin-bottom var(--_ex-transition-duration) cubic-bezier(0, 0, 0, 1),
...
.s-expandable:not(.is-expanded) {
  ...
  --_ex-content-transition: margin-bottom var(--_ex-transition-duration) cubic-bezier(1, 0, 1, 1),
